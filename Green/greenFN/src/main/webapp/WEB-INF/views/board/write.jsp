    	...
    	<div class="writeTitle">
      	...
      	<div class="writeRadioDiv">
        	<label class="typhoonLabel" for="typhoon">
          		<input type="radio" name="category" id="typhoon" value="typhoon"><span>Typhoon</span>
        	</label>
        	<label class="airLabel" for="air">
        		<input type="radio" name="category" id="air" value="air"><span>Air</span>
        	</label>
        	<label class="covid19Label" for="covid19">
          		<input type="radio" name="category" id="covid19" value="covid19"><span>Covid19</span>
        	</label>
      	</div>
      	<div class="writeTextArea">
        <textarea name="content" id="content" placeholder="여기에 작성하세요" 
        		  required onkeyup="fn_checkByte(this)" autofocus></textarea>
      	</div>
      	<div class="wrtieFile">
        	<sup class="writeSup">( <span id="nowByte"> 0 </span> / 3758096384bytes )</sup>
        	<label for="fileInput" class="fileLabel">이미지 업로드</label>
        	<input type="file" id="fileInput" name="uploadFile" required>
      	</div>
      	<div class="writeCansle">
        	<input type="submit" value="작성">
        	<button id="writeCansleBtn">취소</a></button>
      	</div>
	</form>
	</div>
<script>
